...
**a:** Go to the **J2Commerce** icon at the top right corner **-> Localization -> Currencies**

**b:** Go to **Components** on the left sidebar **-> J2Commerce -> Dashboard -> Localization -> Currencies**
