...
![](/img/getting-started-dashboard1.webp)

The **Setup Wizard** should appear if this is a fresh installation

![](/img/getting-started-wizard.webp)
...
![](/img/getting-started-cache.webp)
...
![](/img/getting-started-uninstall.webp)
