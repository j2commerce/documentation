...
**Note:** Load Sample Data will set up everything for you so you know what the whole process is supposed to look like. Remember, these are "fake" products and information; you should hit the **Remove Sample Data** button before going live
