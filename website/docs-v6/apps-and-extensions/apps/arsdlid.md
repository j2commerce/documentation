...
The **ARS Download ID** app connects J2Commerce with [Akeeba Release System (com\_ars)](https://www.akeeba.com/products/akeeba-release-system.html) — the standard Joomla extension update server used by Akeeba, many commercial extension developers, and anyone distributing software through a self-hosted release channel.
