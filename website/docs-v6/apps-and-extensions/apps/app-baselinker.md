...
**Step 2:** Locate the **BaseLinker Integration** app -> click **View Details** -> **Add to Cart -> Checkout**.

**Step 3:** Go to **My Downloads** under your profile button at the top right corner and find the app. Click **Available Versions -> View Files -> Download Now**.

## Install the App

Install the BaseLinker Integration app using the standard Joomla installer.
...
Once installed, enable the app before configuring it. There are two ways to reach the Apps list.

**Option A:** Go to the **J2Commerce** icon at the top right corner **-> Apps**

**Option B:** Go to **Components** in the left sidebar **-> J2Commerce -> Apps**

<!-- SCREENSHOT: J2Commerce Apps list with BaseLinker Integration visible -->

Find **BaseLinker Integration** in the list, click the **X**, and it turns into a green checkmark. The app is now enabled.
...
<!-- SCREENSHOT: BaseLinker Integration > Connection tab -->
...
| **Warehouse ID** | The warehouse in BaseLinker that receives stock level updates. |
| **Order Source ID** | The source ID BaseLinker assigns to orders imported from J2Commerce. Find this in BaseLinker under your store source settings. |
...
<!-- SCREENSHOT: BaseLinker Integration > Synchronization tab -->

Control which data types sync and how often background syncs run.

| Setting | Description | Default |
|---|---|---|
| **Push Orders** | Send new J2Commerce orders to BaseLinker after payment. | On |
| **Push Products** | Push product details to the BaseLinker catalog when a product is saved. | On |
| **Push Inventory** | Push current stock levels to BaseLinker during scheduled syncs. | On |
| **Pull Shipment Tracking** | Pull courier codes and tracking numbers from BaseLinker back into J2Commerce orders. | On |
| **Pull Order Status** | Update J2Commerce order statuses when BaseLinker reports a status change. | On |
| **Scheduled Task Interval** | How often background syncs run automatically (Every 15 minutes / 30 minutes / 1 hour / 6 hours). | Every 15 minutes |
| **Hold Push (minutes)** | Delay in minutes before a newly paid order is eligible to push to BaseLinker. Useful for correcting order errors before they reach BaseLinker (0–1440). | 0 |

---

### Status Mapping Tab

<!-- SCREENSHOT: BaseLinker Integration > Status Mapping tab -->
...
<!-- SCREENSHOT: BaseLinker Integration > Advanced tab -->

| Setting | Description | Default |
|---|---|---|
| **Debug Logging** | Log every API call to `administrator/logs/plg_j2commerce_app_baselinker.log.php`. Useful for diagnosing sync problems. Disable in production. | Off |
...
1. Go to **J2Commerce -> Apps -> BaseLinker Integration**.
...
1. Go to **J2Commerce -> Apps -> BaseLinker Integration -> Status Mapping** tab.
...
1. Go to **J2Commerce -> Apps -> BaseLinker Integration -> Synchronization** tab.
