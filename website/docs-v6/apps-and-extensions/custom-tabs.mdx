...
#### **When to Enable Content Field Short Code**{#when-to-enable-content-field-short-code}
...
#### **When to Enable Prepare Content**{#when-to-enable-prepare-content}
...
#### **Display Brand Details**{#display-brand-details}
...
### **Step 1: Edit a Product**{#step-1-edit-a-product}
...
### **Step 2: Add Tab from Article**{#step-2-add-tab-from-article}
...
### **Step 3: Add Custom Tabs**{#step-3-add-custom-tabs}
...
### **Step 4: Organize Tabs**{#step-4-organize-tabs}
