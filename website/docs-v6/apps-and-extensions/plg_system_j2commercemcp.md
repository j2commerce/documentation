...
1. Purchase and download the `plg_system_j2commercemcp.zip` package from the J2Commerce website.
2. Go to **System** -> **Install** -> **Extensions**.
3. Upload the `plg_system_j2commercemcp.zip` package file.
4. The plugin installs automatically, but you must enable it manually.

<!-- SCREENSHOT: System > Install > Extensions showing the upload panel -->
...
4. Set the status to **Enabled** and configure the options described below.
5. Click **Save & Close**.

## Prerequisites

- J2Commerce installed and activated
...
Go to **System** -> **Manage** -> **Plugins**, search for **J2Commerce MCP**, and open the plugin settings.

<!-- SCREENSHOT: Plugin configuration screen showing all fields -->
...
**Solution:**
Set the `JOOMLA_ROOT` environment variable in your AI tool's MCP configuration to the absolute path of your Joomla installation root, for example `/var/www/html`.
