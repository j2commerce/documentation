...
You set your preferred layout once in **J2Commerce -> Setup -> Configuration** -> **Store** tab. Look for the **Sub-template** field and select the option that matches your template. Individual menu items can override this setting if you need different layouts on different pages of your site.
