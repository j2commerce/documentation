...
- View all orders with filtering by status, date, customer, and payment method
- Order details include billing/shipping addresses, items, totals, and payment information
- Update order statuses with customer notifications
...
- Percentage discounts (cart-wide or per-product)
