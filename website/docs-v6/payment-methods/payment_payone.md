---
title: "PAYONE Commerce Platform Payment"
sidebar_label: "PAYONE"
sidebar_position: 87
description: "Accept card payments through the PAYONE Commerce Platform — with Hosted Checkout Page redirect, Hosted Tokenization iframe, saved cards, subscription renewals, pre-authorization, capture, void, and refund."
---
...
Upload the `payment_payone.zip` file or use the Install from URL option.

<!-- SCREENSHOT: System > Install > Extensions upload screen with payment_payone.zip selected -->
...
<!-- SCREENSHOT: J2Commerce Payment Methods list showing PAYONE with a disabled status indicator -->

Search for **PAYONE**, click the status indicator to toggle it to enabled (green checkmark). The plugin is now active and ready for configuration.

<!-- SCREENSHOT: PAYONE entry showing enabled green checkmark in the Payment Methods list -->

## Configure the Plugin

Click the **PAYONE** title to open its settings.

:::tip
Click the **Toggle Inline Help** button at the top of any plugin settings screen to show a short description beneath each field.
:::

<!-- SCREENSHOT: PAYONE plugin settings screen with Toggle Inline Help button highlighted -->
...
<!-- SCREENSHOT: PAYONE plugin settings showing the live credentials section -->
...
<!-- SCREENSHOT: PAYONE plugin settings showing the sandbox credentials section -->
...
<!-- SCREENSHOT: PAYONE plugin settings showing the order status section -->

| Field | Description | Default |
|-------|-------------|---------|
| **Order Status (Payment Success)** | Status applied when PAYONE confirms a successful payment | Confirmed |
| **Authorized Status** | Status applied when payment is authorized but not yet captured — only shown for Pre-authorization and Final authorization modes | Confirmed |
| **Failed Status** | Status applied when a payment is declined or fails | Failed |
| **Change Status on Refund** | When switched on, automatically updates the order status after a refund is processed | No |
| **Refund Order Status** | The status to apply after a refund — only shown when Change Status on Refund is enabled | — |
| **Change Status on Cancel** | When switched on, automatically updates the order status after a payment is voided or cancelled | No |
...
**Dashboard Icon Label:** The label for the shortcut. Defaults to "PAYONE" if left blank.
...
<!-- SCREENSHOT: Checkout payment step showing the PAYONE redirect notice and Continue to Payment button -->
...
<!-- SCREENSHOT: Checkout payment step showing the PAYONE tokenization iframe with card fields -->
...
<!-- SCREENSHOT: Order detail screen showing the PAYONE Capture button -->
...
<!-- SCREENSHOT: Order detail screen showing the PAYONE Void/Cancel button -->
...
<!-- SCREENSHOT: Order detail screen showing the PAYONE Refund button and refund amount fields -->
...
<!-- SCREENSHOT: J2Commerce dashboard showing "PAYONE is in sandbox (test) mode. No real payments are processed." warning banner -->
