...
1. Log in to your 2Checkout / Verifone Central dashboard.
2. Go to **Account** -> **Site Management**.
3. Under the **INS** (Instant Notification Service) section, locate the **Notification URL** or **INS URL** field.
4. Paste the following URL (replace `https://yoursite.com` with your store's actual domain):
...
2. Make sure your **Account Number (SID)** and **Secret Word** are for your sandbox account, not your live account.
