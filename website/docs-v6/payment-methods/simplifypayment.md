...
If your store uses subscription products (via the app\_subscriptionproduct add-on), Simplify Payments can accept the initial subscription payment. The **Support Subscriptions** setting must be set to **Yes**.
