...
‌**Step 1:** Go to our [**J2Commerce website**](https://www.j2commerce.com/) > **Plugin**
...
You can install this UPS shipping plugin using the Joomla installer. The following steps help you with a successful installation.
