...
1. Go to the [J2Commerce website](https://www.j2commerce.com) and locate **Klarna Invoice**.
...
Upload the `plg_j2commerce_payment_klarnainvoice.zip` file.
...
To help you narrow down the list, you can do a search for **Klarna Invoice**, click the **X,** and it will turn into a green checkmark. It is now enabled and ready for setup.

![](/img/klarna-invoice-enable.webp)
...
![](/img/klarna-invoice-toggle.webp)

### Display Settings

![](/img/klarna-invoice-display.webp)

**Display Name:** The payment method name shown to shoppers at checkout — e.g., "Pay Later with Klarna"

**Display Image:** Optional logo or badge shown alongside the payment option at checkout

### Invoice Due Days

![](/img/klarna-invoice-transaction.webp)

**Invoice Due Days:** Number of days the customer has to pay the invoice after delivery. Options are 14 or 30
...
![](/img/klarna-invoice-sandbox.webp)
...
![](/img/klarna-invoice-b2b.webp)

**Enable B2B:** Allow business customers to use their company registration number for invoice payment

**Company Number:** Your business registration or company number for B2B invoicing (shown when Enable B2B is Yes)
...
**Template Layout:** Choose the checkout template — **Bootstrap 5** (default) or **UIkit** — to match your site's frontend framework
...
![](/img/klarna-invoice-surcharge.webp)
...
![](/img/klarna-invoice-restriction.webp)
...
![](/img/klarna-invoice-messages.webp)

These text areas let you insert custom HTML or text at specific points in the checkout flow.

**Thank-You Article (Optional):** Use the **Thank You Message** field to link a Joomla article that will be displayed to the customer after a successful Klarna Invoice payment, in addition to the standard J2Commerce order confirmation.
...
### Dashboard Icon and Debug (Optional)

![](/img/klarna-invoice-icon.webp)

**Show Dashboard Icon:** Add a Klarna Invoice shortcut to the J2Commerce dashboard

**Icon Label:** Label text for the dashboard shortcut (shown when **Show Dashboard Icon** is Yes)

**Debug Logging:** Log Klarna API requests and responses to the Joomla system log. Useful for troubleshooting — turn off in production.
...
1. Go to **J2Commerce** -> **Setup** -> **Payment Methods** -> **Klarna Invoice**.
