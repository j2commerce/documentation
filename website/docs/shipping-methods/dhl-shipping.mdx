...
## ‌Purchase the Plugin{#installation}
...
You can install this DHL Express shipping plugin using the Joomla installer. The following steps help you with a successful installation.
