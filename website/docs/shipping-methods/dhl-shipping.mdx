...
**Step 2:** Locate the DHL Shipping App > click View Details > Add to cart > Checkout.&#x20;

**Step 3:** Go to your My Download under your profile button at the top right corner and search for the app. Click Available Versions > View Files > Download Now

![](/img/dhl-download2.webp)

**Installation:** You can install this DHL shipping plugin, using Joomla installer. The following steps help you for successful installation.

**Step 1:** In the Joomla admin, go to System > Install > Extensions

![](/img/dhl-installer-1.webp)

**Step 2**: Click on the Browse button and select the DHL Shipping zip file you saved during the download process. You will receive a message of success once installed.
...
**Test Mode:** Toggle between sandbox (testing) and production (live) environments.

**‌Display Shipping Error:** The information sent to the DHL API was invalid and the system could not generate a valid shipping rate, label, or complete another shipping-related action

**Show Transit Time:** Enabling this field displays the delivery time for each DHL service
