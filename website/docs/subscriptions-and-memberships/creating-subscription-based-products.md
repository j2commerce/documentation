...
## Creating a simple subscription product <a href="#creating-simple-subscription-product" id="creating-simple-subscription-product" />
...
## Creating a variable subscription product <a href="#creating-variable-subscription-product" id="creating-variable-subscription-product" />
...
Go to J2Commerce > Subscription&#x20;

![subs button](/img/subscription.webp)

Click on this button to view the customers with a subscription and the details and status.

![subs detail](/img/subscription-detail1.webp)
