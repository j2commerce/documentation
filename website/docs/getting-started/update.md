...
## Adding license key <a href="#adding-license-key" id="adding-license-key" />
...
2: In our website’s My Account section. Click on your profile on the top right corner > My Account, and you will see your "Download ID".
...
## Updating directly <a href="#updating-directly" id="updating-directly" />
...
## Updating via Extensions Manager <a href="#updating-via-extensions-manager" id="updating-via-extensions-manager" />
...
## Updating from FREE to PRO version <a href="#updating-from-free-to-pro-version" id="updating-from-free-to-pro-version" />
...
## Firewall <a href="#firewall" id="firewall" />
...
## Timeout <a href="#timeout" id="timeout" />
