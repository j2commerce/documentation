...
This is an example setting for stores in the United States. This also applies to many other countries that follow a US-style tax system. For detailed information on taxes, please consult an expert. J2Commerce is not held responsible VAT / Tax changes.
...
## Create a geozone for Texas <a href="#step-1--create-a-geozone-for-texas" id="step-1--create-a-geozone-for-texas" />

![Geozone setup](../../assets/tax7.webp)

![Geozone setup](../../assets/tax8.webp)

Go to J2Commerce > Localization -> Geozones -> New
...
Go to J2Commerce > Localization -> Tax Profiles -> New
...
Go to J2Commerce > Setup > Configuration > Tax tab
...
## Add the tax profile to a product <a href="#step-5-create-a-product-and-choose-the-tax-profile" id="step-5-create-a-product-and-choose-the-tax-profile" />
