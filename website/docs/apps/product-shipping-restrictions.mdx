...
The following section is if you chose the Simple mode in the App.  See the image below.
...
![](/img/restrictions-simple-variant.webp)
...
### Setting up Non-Variable Products
