...
![Enable custom tab app](/img/reviews-enable.webp)

Click on "Open App" or the Title to start setting up the app.&#x20;

![](/img/reviews-enable-open.webp)
...
**Form Display Mode:** How to display the review submission form. Inline or a pop-up Modal window
...
*Note: The screenshot below shows an example of how two colors are displayed on the frontend*
