...
**Step 2:** Locate the Google Analytics E-commerce Tracking App > click View Details > Add to cart > Checkout.&#x20;
...
Go to Components > J2Commerce > Apps.&#x20;

Enable the Google Analytics E**-**commerce App. Open it to configure it
