...
![](/img/advanced-checkout-login-module.webp)

Name the module Login.

**Position:** Select J2c-login. If it doesn't show up in the dropdown menu, just start typing it in and it will show up
